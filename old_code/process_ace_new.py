"""
This processing is from amr-ie and shouldn't be used anymore
...
def convert_to_oneie(input_path: str,
    ...
    with open(input_path, 'r', encoding='utf-8') as r, \
        ...
        # first use old tokenization method
        for line in r:
            doc = json.loads(line)
            for sentence in doc['sentences']:
                ...
                # then transoform it to the new format
                new_sent_obj = transform_for_amrie(sent_obj, tokenizer)
                w.write(json.dumps(new_sent_obj) + '\n')
