...
class BilinearMatrixAttention(nn.Module):
    ...
    def __init__(self,
        ...
        self._weight_matrix = Parameter(torch.Tensor(matrix_1_dim, matrix_2_dim)) # H, H
    ...
    def forward(self, matrix_1: torch.Tensor, matrix_2: torch.Tensor) -> torch.Tensor:
        ...
        # ret = torch.matmul(matrix_1, weight.unsqueeze(0)) # 23, H * 1 ,H, H 
        # print(ret.shape)
        # ret = torch.matmul(ret, matrix_2.transpose(1, 2)) # (23, H) (1, H ,1) -> (1, 1)
        ret = torch.matmul(matrix_1, weight)
        ret = torch.matmul(ret, matrix_2.transpose(0, 1)) # (23,1)
        return ret