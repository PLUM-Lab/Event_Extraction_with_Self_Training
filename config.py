...
class Config(object):
    def __init__(self, **kwargs):
        ...
        self.beam_size = kwargs.pop('beam_size', 10)
        ...
        self.role_O_weight = kwargs.pop('role_O_weight', 1.0)
        # files
        ...
        # self.training
        self.test_beam_size = kwargs.pop('test_beam_size', 10)
        self.mix_ratio = kwargs.pop('mix_ratio',1.0)
        self.feedback = kwargs.pop('feedback',True)
        self.further_train = kwargs.pop('further_train',False)
    ...
    def bert_config(self):
        ...
        elif self.bert_model_name.startswith('roberta-') or self.bert_model_name.startswith('roberta_'):
            self.bert_model_name = self.bert_model_name.replace('roberta_','roberta-')
