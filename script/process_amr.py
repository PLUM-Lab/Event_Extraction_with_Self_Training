"""
This label roberta or bert ie with AMR
"""
import torch
import dgl
import json
...
def amr_parse(tokens_list, output_dir):
    parser = AMRParser.from_checkpoint('YOUR_AMR_PARSER_CHECKPOINT_PATH')
...
if __name__ == "__main__":
    ...
    print('process dev')
    get_amr_data("dataset/ACE05-E/roberta_large/dev.oneie.json", "dataset/ACE05-E/roberta_large/dev_graphs.pkl", "dataset/ACE05-E/roberta_large/dev_amrs.pkl")
    print('process test')
    get_amr_data("dataset/ACE05-E/roberta_large/test.oneie.json", "dataset/ACE05-E/roberta_large/test_graphs.pkl", "dataset/ACE05-E/roberta_large/test_amrs.pkl")
    print('process train')
    get_amr_data("dataset/ACE05-E/roberta_large/train.oneie.json", "dataset/ACE05-E/roberta_large/train_graphs.pkl", "dataset/ACE05-E/roberta_large/train_amrs.pkl")
